...
export function getMiningPoolLink(token0Address) {
  return `https://swap.pippi.finance/#/pipi/ETH/${token0Address}`
}
...
export const urls = {
  showTransaction: (tx) => `tokenAddr/tx/${tx}/`,
  showAddress: (address) => `tokenAddr/address/${address}/`,
  showToken: (address) => `tokenAddr/tokenAddr/${address}/`,
  showBlock: (block) => `tokenAddr/block/${block}/`,
}
