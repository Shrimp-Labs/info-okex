          ...
          <DashboardWrapper style={{ marginTop: below1080 ? '0' : '1rem' }}>
            ...
            <RowBetween style={{ marginTop: '3rem' }}>
              ...
              <AutoRow gap="4px" style={{ width: 'fit-content' }}>
                ...
                />
                <QuestionHelper text="HUSD amounts may be inaccurate in low liquiidty pairs or pairs without OKB or stablecoins." />
              </AutoRow>
            </RowBetween>
            <Panel
              rounded
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={'https://www.oklink.com/okexchain/tokenAddr/' + address}>
                      View on OEC ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
